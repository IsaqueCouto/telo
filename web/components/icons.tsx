...
export function PlayIcon({ size = 20, color = "#A0855C" }: P) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <polygon points="5 3 19 12 5 21 5 3" fill={color} stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}

export function PauseIcon({ size = 20, color = "#A0855C", strokeWidth = sw }: P) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <line x1="8"  y1="5" x2="8"  y2="19" stroke={color} strokeWidth={strokeWidth + 1} strokeLinecap="round"/>
      <line x1="16" y1="5" x2="16" y2="19" stroke={color} strokeWidth={strokeWidth + 1} strokeLinecap="round"/>
    </svg>
  );
}

export function SkipBackIcon({ size = 20, color = "#A0855C", strokeWidth = sw }: P) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <polygon points="19 20 9 12 19 4 19 20" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
      <line x1="5" y1="19" x2="5" y2="5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round"/>
    </svg>
  );
}

export function SkipForwardIcon({ size = 20, color = "#A0855C", strokeWidth = sw }: P) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <polygon points="5 4 15 12 5 20 5 4" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
      <line x1="19" y1="4" x2="19" y2="20" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round"/>
    </svg>
  );
}

export function XIcon({ size = 20, color = "#A0855C", strokeWidth = sw }: P) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
