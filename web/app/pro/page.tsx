    ...
    <div style={{ background: S.bg, minHeight: "100vh", fontFamily: S.sans }}>
      ...
      <div style={{ padding: "52px 24px 0" }}>
        ...
        <div style={{ marginBottom: 32 }}>
          <p style={{ fontSize: 11, color: S.copper, textTransform: "uppercase" as const, letterSpacing: "0.1em", fontWeight: 700, marginBottom: 10, fontFamily: S.sans }}>Telos Pro</p>
      ...
      <div style={{ margin: "0 24px 24px", display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <span style={{ color: S.copper, fontSize: 14 }}>✦</span>
        <div style={{ flex: 1, height: 1, background: S.border }} />
      </div>
      ...
      <div style={{ padding: "0 24px 56px" }}>
        <div style={{ background: S.card, borderRadius: 24, padding: "32px 28px", border: `1px solid ${S.border}`, textAlign: "center" as const, boxShadow: "0 4px 16px rgba(0,0,0,0.07)" }}>
          ...
          <p style={{ fontFamily: S.serif, fontSize: 60, fontWeight: 900, color: S.copper, letterSpacing: "-3px", lineHeight: 1 }}>
            R$14,90
          </p>
          <p style={{ fontSize: 14, color: S.gray, marginTop: 6, marginBottom: 28, fontFamily: S.sans }}>por mês · cancele quando quiser</p>
          <button
            style={{ width: "100%", background: S.copper, color: "#FFFFFF", border: "none", borderRadius: 14, padding: "18px", fontSize: 16, fontWeight: 900, cursor: "pointer", fontFamily: S.serif, letterSpacing: "-0.2px", boxShadow: "0 6px 20px rgba(216,104,59,0.35)" }}
          >
            Assinar Pro
          </button>
